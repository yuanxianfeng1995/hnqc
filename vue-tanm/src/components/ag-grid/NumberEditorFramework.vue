<template>
  <el-input-number ref="input" v-model="value" size="mini" :controls="options.controls" :disabled="isDisabled()" @change="onChange" placeholder="请输入文本" >
  </el-input-number>
</template>
...
<script>
  ...
  export default Vue.extend({
    data () {
      return {
        options: {rule: [], isDisabled: null, controls: false},
        value: null
      }
    },
    computed: {
